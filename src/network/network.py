...
class Network:
    ...
    def _initialize_run(self, image_path: str, process_outside_nodes: bool) -> None:
        ...
        # Pre-mark outside areas in the id_map for door typing logic, only on ground floor.
    ...
    def run(
        ...
        )  # process_outside_nodes now correctly controls mesh creation
