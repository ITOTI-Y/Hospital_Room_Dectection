...
class AutoregressiveActor(nn.Module):
    ...
    def forward(
        ...
        action1 = dist1.probs.argmax(dim=-1) if deterministic else dist1.sample()  # type: ignore (batch_size,)
        ...
        action2 = dist2.probs.argmax(dim=-1) if deterministic else dist2.sample()  # type: ignore (batch_size,)
